...
def generate_launch_description():
    ...
    #         [pkg_name, 'config', 'turtlebot4_node.yaml']),
    ...
    robot_name = 'puzzlebot'#GetNamespacedName(namespace, 'turtlebot4')
